...
public class FinanceDepartmentAttributeProvider : RecordAttributeValueProvider<FinanceDepartmentLimits>
{
    ...
    protected  override async Task<FinanceDepartmentLimits> GetRecordValue(IAttributeResolver attributeResolver, CancellationToken ct)
    {
        ...
        IReadOnlyCollection<string> departments =
            await attributeResolver.Resolve<string>(Department, ct);
    ...
    // protected override Task<FinanceDepartmentLimits> GetRecordValue(IAttributeResolver attributeResolver, CancellationToken ct)
    // {
